...
@implementation DrawLineChartView{
    float bounceX ;
    float bounceY ;
    int countq;
}
...
- (void)setLineDash{
    ...
    for (NSInteger i = 0;i < 6; i++ ) {
        ...
        [dashLayer setLineDashPattern:[NSArray arrayWithObjects:[NSNumber numberWithInt:5], [NSNumber numberWithInt:5], nil]];
