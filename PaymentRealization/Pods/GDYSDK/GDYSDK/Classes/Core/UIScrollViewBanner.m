...
- (void)setMaxImageCount:(NSInteger)MaxImageCount {
    ...
    if (MaxImageCount > 1) {
        ...
        [self changeImageLeft:_MaxImageCount-1 center:0 right:0];//出事位置
...
//        [self changeImageLeft:_MaxImageCount-1 center:0 right:1];//初始位置
//    }
//    else{
//        [self changeImageLeft:_MaxImageCount-1 center:0 right:0];
//    }
}
...
- (void)createPageControl
{
    ...
    float Hight = ceilf(GDHeight - pageSize);
    UIPageControl *page = [[UIPageControl alloc] initWithFrame:CGRectMake(0,Hight,GDWidth, 10)];
